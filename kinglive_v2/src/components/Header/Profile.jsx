...
export default function Profile({ IsOpenProfile, toggleHeader }) {
  ...
  return (
    <>
      <div onClick={(e) => toggleHeader(3, e)} className='profile'>
        ...
        <div className={`dropdown ${IsOpenProfile ? 'show' : ''}`}>
          ...
          <div className='mid'>
            ...
            <div
              className='item'
              onClick={() => window.open(`${EXPLORER_URL}address/${account}`, '_blank')}
            >
              <svg
                width='14'
                height='15'
