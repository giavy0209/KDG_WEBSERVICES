    ...
    return (
        ...
        <div className='search'>
            <div className='container live-container'>
                <div className='left'>
                    {SearchUser.length && <div className='title-controls'>
                        <h2 className='title'>Users</h2>
                    </div>}

                    {
                        SearchUser.length && <div className="list-user">
                            {SearchUser.map(o => <div key={o._id} onClick={()=>history.push(`/user?uid=${o._id}`)} className="item">
                                        ...
                                        <div className='detail-avatar'>
                                            ...
                                            <div className='detail'>
                                                ...
                                                <div className='view-time'>
                                                    ...
                                                    {convertDateAgo(video.start_date)}
                                                </div>
                                                <div className='user-name'>
                                                    {video.user?.kyc?.first_name
