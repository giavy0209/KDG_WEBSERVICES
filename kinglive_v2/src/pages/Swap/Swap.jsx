                    ...
                    <div onLoad={setHeight} className="list-swap">
                        <div className="item">
                            <div className="swap-method">
                                <img src={pancake} alt="" />
                                <a href="https://pancakeswap.finance/swap#/swap?outputCurrency=0x87a2d9a9a6b2d61b2a57798f1b4b2ddd19458fb6" target="_blank" rel="noreferrer" className="swap-btn">Swap</a>
                            </div>
                        </div>
                        <div className="item">
                            <div className="swap-method">
                                <img src={bscs} alt="" />
                                <a href="https://bscstation.finance/#/swap?outputCurrency=0x87a2d9a9a6b2d61b2a57798f1b4b2ddd19458fb6" target="_blank" rel="noreferrer" className="swap-btn">Swap</a>
                            </div>
                        </div>
                        <div className="item">
                            <div className="swap-method">
                                <img src={mxc} alt="" />
                                <a href="https://www.mexc.com/exchange/KDG_USDT" target="_blank" rel="noreferrer" className="swap-btn">Swap</a>
                            </div>
                        </div>
                    </div>
                </div>
