        ...
        <>
            <div className="live">
                <div className="slide-track">
                    <div style={{ '--translate': -(100 / slide.length) * ActiveSlide + '%' }} className="slide">
                        {
                            slide.map(o => <div className="item">
                                <img src={o} alt="" />
                            </div>
                            )
                        }
                    ...
                    <div className="controls">
                        {
                            slide.map((o, index) => <div onClick={() => manualChangeSlide(index)} className={`btn ${ActiveSlide === index ? 'active' : ''}`}></div>)
                        }
                    </div>
                </div>
                <div className="container live-container">
                    <div className="left">
                        ...
                        <div className="watch-live-track">
                            <div style={{ '--total-item': 100, '--translate': -(33.33333 / live.length) * ActiveLive + '%' }} className="watch-live">
                                {
                                    live.map(o => <div className="item">
                    ...
                    <div className="right">
                        <div style={{'--item' : ActiveTab}} className="ranking">
                            ...
                            <div className="tabs">
                                <div onClick={()=>setActiveTab(0)} className={`tab ${ActiveTab === 0 ? 'active' : ''}`}>Followers</div>
                                <div onClick={()=>setActiveTab(1)} className={`tab ${ActiveTab === 1 ? 'active' : ''}`}>Views</div>
                            </div>
