            ...
            <div className='form-block'>
                ...
                <div className='right'>
                    <form onSubmit={handleReg}>
                        ...
                        <span>
                            {checkLanguage({ vi: 'Đã có tài khoản?', en: 'Already have an account?' }, language)} <span onClick={() => history.push('/login')}>{checkLanguage({ vi: 'Đăng nhập', en: 'Log in' }, language)}</span>
                        </span>
                        ...
                        <div className='form-group half'>
                            <button style={ValidForm.email && ValidForm.password && ValidForm.email_code && ValidForm.repassword && check ? { opacity: 1, pointerEvents: 'all' } : { opacity: 0.6, pointerEvents: 'none' }} className='button'>
