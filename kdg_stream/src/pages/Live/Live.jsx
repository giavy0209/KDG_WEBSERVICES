        ...
        <div className={`live ${isExpand ? 'expand' : ''}`}>
            <div className='live__left'>
                <div className={`live__videoCtn ${isFullScreen ? 'fullscreen' : ''}`}>
                    {isFullScreen && (
                        <div
                            className={`live__chatfullscreen ${isHideFullscreenChat ? 'hide' : ''}`}
                        >
                            <div
                            ...
                            <div className='live__chatfullscreen-top'>
                                ...
                                <div className='live__chatfullscreen-top-ctn'>
                                    ...
                                    <div>
                                        ...
                                        <div className='live__chatfullscreen-top-ctn-text'>
                                            tụi FAPtv nói chung, blackbi nói riêng hay có mấy vụ cà
                                            khịa kiểu này lắm. Vụ của AnVy, vụ của Jack, kiểu nói mé
                                            mé ko tới đâu :))))
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        <div
                            className='live__videoCtn-controls-top'
                        ...
                        <div className='live__videoCtn-controls-bottom'>
                            ...
                            <div>
                                ...
                                >
                                    {!isFullScreen ? (
                                        <RiIcon.RiFullscreenLine />
                                    ) : (
                                        <RiIcon.RiFullscreenExitLine />
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='live__chatBox-top'>
                            ...
                            <div className='live__chatBox-top-ctn'>
                                ...
                                <div>
                                    ...
                                    <div className='live__chatBox-top-ctn-text'>
                                        tụi FAPtv nói chung, blackbi nói riêng hay có mấy vụ cà khịa
                                        kiểu này lắm. Vụ của AnVy, vụ của Jack, kiểu nói mé mé ko
                                        tới đâu :))))
                                    </div>
                                </div>
                            </div>
