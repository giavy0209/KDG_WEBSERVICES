...
const FormRegister = ({ setCurrentForm }) => {
    const [{ language, formRegister }] = useLanguageLayerValue();
        ...
        try {
            ...
            if (response.status === 1) {
                NotificationManager.success(
                    formRegister[language].getCodeEvent.success,
                    null,
                    2000
                );
            } else if (response.status === 101) {
        ...
        <form className='login-form' onSubmit={handleSubmitForm}>
            ...
            <p className='login-form__subtitle'>
                ...
                <span onClick={() => setCurrentForm('login')}>
                    {formRegister[language].subtitle2}
                </span>
            </p>
            ...
            <div className='form-control'>
                <label htmlFor='confirmPasswordRegister'>
                    {formRegister[language].confirmPassword}
                </label>
                <input
