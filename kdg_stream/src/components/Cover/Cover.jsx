...
const Cover = () => {
    ...
    return (
        <div className='position-relative userSelect-none'>
            ...
            <div
                className={`coverOverlay coverOverlayLeft ${
                    activeIndex === itemCover - 1 ? 'show' : ''
                }`}
            ></div>
            <div
                className={`coverOverlay coverOverlayRight ${
                    activeIndex === itemCover - 1 ? '' : 'show'
                }`}
            ></div>
            ...
            <div className='coverTrack'>
                <div className='cover' style={{ '--item': itemCover }}>
                    <div className='cover__item' onClick={() => history.push('/live')}>
                        <img src={thumb1} alt='' />
                    </div>
                    <div className='cover__item' onClick={() => history.push('/live')}>
                        <img src={thumb2} alt='' />
