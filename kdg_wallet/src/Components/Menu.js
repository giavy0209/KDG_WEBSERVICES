            ...
            <header>
                <div class="kdg-container">
                    <div class="top-header">
                        <div class="social">
                            ...
                            <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/channel/UCl7ezf4kJUxjlPJwaoPtapA/featured">
                    ...
                    <div>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope" class="svg-inline--fa fa-envelope fa-w-16 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color="#fac800"><path fill="currentColor" d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"></path></svg>
                    <span class="mail">contact@kingdomgame.co</span>
                    </div>
                    <div class="lang"><span>{language.toUpperCase()}</span>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-down" class="svg-inline--fa fa-caret-down fa-w-10 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M31.3 192h257.3c17.8 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 13.5 192 31.3 192z"></path></svg>
                    <ul class="dropdown">
                        <li onClick={()=>{dispatch(atcChangeLanguage('en'))}}>EN</li>
                        <li onClick={()=>{dispatch(atcChangeLanguage('vi'))}}>VI</li>
                    </ul>
                    </div>
                    </div>
                </div>
                <div className="bottom-header">
                    <div className="kdg-container logo-menu">
                        <span class="menubar"><img src="data:image/png;base64," alt="" /></span>
                        <span className="mask-menu"></span>
                        <a className="logo" href="/"><img alt="KingDomGame" src={logo} /></a>
